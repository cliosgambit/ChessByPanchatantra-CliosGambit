...
import { getThemeByKey, getThemeForIndex } from './moduleThemes';
 ...
 */
function ModuleCard({ module, index = 0, onClick, selectable = false, selected = false }) {
  ...
  const theme = module.themeKey
    ? getThemeByKey(module.themeKey, colorMode)
    : getThemeForIndex(legacyIndex, colorMode);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Heading size="lg" mb={2} letterSpacing="-0.02em">
