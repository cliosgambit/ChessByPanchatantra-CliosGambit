...
router.get('/chess-com/pioneer-wins', controller.getPioneerWins);
router.get('/chess-com/pioneer-wins/scan-targets', controller.getPioneerScanTargets);
router.post('/chess-com/pioneer-wins/detect-one', controller.detectPioneerWinOne);
router.post('/chess-com/pioneer-wins/detect', controller.detectPioneerWins);
router.get('/chess-com/pioneer-wins/:uuid', controller.getPioneerWin);
